...
class MatchstickModelTest {
    ...
    @Test
    public void theSmallestNumberOfMatchesForTwentyFiveCubes() {
        int inputN = 25;
        int output = 138; // 0+12+8+8+5+8+5+5+3+8+5+5+3+8+5+5+3+5+3+8+5+5+3+5+3+5
        Assertions.assertEquals(output, new MatchstickModel().theMinimumNumberOfMatchesToImplementNCubes(inputN));
        /*
                     /-----------/-----------/-----------/
                    /|          /|          /|          /|
    ...
    @Test
    public void theSmallestNumberOfMatchesForTwentySixCubes() {
        int inputN = 26;
        int output = 141; // 0+12+8+8+5+8+5+5+3+8+5+5+3+8+5+5+3+5+3+8+5+5+3+5+3+5+3
        Assertions.assertEquals(output, new MatchstickModel().theMinimumNumberOfMatchesToImplementNCubes(inputN));
        /*
                     /-----------/-----------/-----------/
                    /|          /|          /|          /|
    ...
    @Test
    public void theSmallestNumberOfMatchesForTwentySevenCubes() {
        int inputN = 27;
        int output = 144; // 0+12+8+8+5+8+5+5+3+8+5+5+3+8+5+5+3+5+3+8+5+5+3+5+3+5+3+3
        Assertions.assertEquals(output, new MatchstickModel().theMinimumNumberOfMatchesToImplementNCubes(inputN));
        /*
                     /-----------/-----------/-----------/
                    /|          /|          /|          /|
